    ...
    <div className='grid lg:grid-cols-5 gap-4 p-4'>
        ...
        <div className="lg:col-span-2 col-span-1 bg-white flex justify-between w-full border p-4 rounded">
            ...
            <div className='flex flex-col w-full pb-4'> 
                ...
                <p className='text-2xl font-bold'> $1,437,951 </p>

                <p className='text-gray-600'> Year-To-Date Revenue </p>
        ...
        <div className=" bg-white flex justify-between w-full border p-4 rounded">

            <div className='flex flex-col w-full pb-4'> 

                <p className='text-2xl font-bold'> 66,111 </p>
